        ...
        return [
            ...
            'properties' => [
                ...
                'operator' => [
                    ...
                    'enum' => $operators,
                    'enumLabelKeys' => [
                        'connectors.logic.filter.operator.equals',
                        'connectors.logic.filter.operator.not_equals',
                        'connectors.logic.filter.operator.contains',
                        'connectors.logic.filter.operator.not_contains',
                        'connectors.logic.filter.operator.greater',
                        'connectors.logic.filter.operator.greater_equal',
                        'connectors.logic.filter.operator.less',
                        'connectors.logic.filter.operator.less_equal',
                        'connectors.logic.filter.operator.is_empty',
                        'connectors.logic.filter.operator.is_not_empty',
                        'connectors.logic.filter.operator.regex',
                    ],
                    'default' => 'equals',
                    'x-position' => 1,
                ],
